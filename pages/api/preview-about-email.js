...
<img src="/hoodfair_logo.svg" alt="Hoodfair" width="180" style="display: block; border: 0; max-width: 100%; height: auto;">
                    </div>
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      ...
                      <tr>
                        <td style="padding: 12px 0;">
                          ...
                          <a href="mailto:support@hoodfair.com" style="color: #3b82f6; text-decoration: none; font-size: 16px;">support@hoodfair.com</a>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 12px 0;">
    ...
    const textTemplate = `
      ...
      Welcome to Hoodfair, the trusted destination for smart shoppers who want quality products at fair and transparent prices.
